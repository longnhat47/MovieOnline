...
urlpatterns = [
    ...
    path('category/<slug:slug>', CategoryRetrieveUpdateDeleteView.as_view(), name='category-detail'),

    path('country', ListCountryView.as_view(), name='country'),
    path('country/create', CreateCountryView.as_view(), name='country-create'),
    path('country/<slug:slug>', CountryRetrieveUpdateDeleteView.as_view(), name='country-detail'),
    ...
    path('movie/<slug:slug>', MovieUpdateDeleteView.as_view(), name='movie-edit'),
    path('movie/update-view/<slug:slug>', MovieUpdateView.as_view(), name='movie-update-view'),
